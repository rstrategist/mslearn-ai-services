$account_id="YOUR_ACCOUNT_ID" # The account ID can be found in the Video Indexer portal https://www.videoindexer.ai
$api_key="YOUR_API_KEY" # The API key can be found in the Video Indexer portal https://api-portal.videoindexer.ai/profile
$location="trial"
